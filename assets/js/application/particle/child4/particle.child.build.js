...
export default class{
    ...
    initGPGPU(renderer){
        this.gpuCompute = new GPUComputationRenderer(PARAM.col, PARAM.row, renderer)

        const pos = this.gpuCompute.createTexture()
        const life = this.gpuCompute.createTexture()

        METHOD.fillPosTexture(pos, this.size.obj)
        ...
        this.posUniforms['width'] = {value: this.size.obj.w}
        this.posUniforms['height'] = {value: this.size.obj.h}
        this.posUniforms['col'] = {value: PARAM.col}
        this.posUniforms['row'] = {value: PARAM.row}
        // this.posUniforms['x'] = {value: 0.0}
        // this.posUniforms['y'] = {value: 0.0}

        this.lifeUniforms['time'] = {value: 0.0}
    ...
    animate(){
        ...
        this.lifeUniforms['time'].value = time
